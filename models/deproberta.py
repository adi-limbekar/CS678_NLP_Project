...
class DepRoBERTa:
    ...
    def __init__(self,
                 ...
                 model_version="v1",
                 pretrain_model=None,
                 data_dir="project_NLP/depression-detection-lt-edi-2022/data/reddit_depression_corpora",
    ...
    def _get_data(self):
        ...
        train_data = '../data/reddit_depression_corpora/reddit_depression_corpora_train_1.txt'
        val_data = '../data/reddit_depression_corpora/reddit_depression_corpora_val_1.txt'
